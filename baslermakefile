...
# libraries
LIB = -L/usr/local/lib -lserial -L/usr/lib/x86_64-linux-gnu  -L/opt/pylon5/lib64  -lpylonbase -lpylonutility -lGenApi_gcc_v3_1_Basler_pylon_v5_1 -lGCBase_gcc_v3_1_Basler_pylon_v5_1  -Wl,--enable-new-dtags -Wl,-rpath,/opt/pylon5/lib64

# -lcgicc

# includes
INC = -I/usr/include -I/usr/local/include -I/opt/pylon5/include   #-I/usr/local/include/opencv2 -I/usr/local/include/opencv 
